...
public class DeviceTest extends Instrumentation {
    private int seconds;
    @Override public void onCreate(Bundle b) { super.onCreate(b); seconds=Integer.parseInt(b.getString("seconds","20")); start(); }
    ...
    @Override public void onStart() {
        ...
        } catch(Throwable e) { result.putString("result","Probe failed: "+e.getClass().getSimpleName());finish(Activity.RESULT_CANCELED,result); }
    }
}
