...
xcrun swiftc -swift-version 5 "$ROOT/mac/Protocol.swift" "$ROOT/mac/AACEncoder.swift" "$ROOT/mac/LatencySettings.swift" "$ROOT/tests/main.swift" -o "$ROOT/build/tests/wire-server"
