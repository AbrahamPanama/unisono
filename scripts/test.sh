...
xcrun swiftc -swift-version 5 "$ROOT/mac/LatencySettings.swift" "$ROOT/mac/DebugSettings.swift" "$ROOT/tests/LatencySettingsTest.swift" -o "$ROOT/build/tests/latency-settings-test"
xcrun swiftc -swift-version 5 "$ROOT/mac/LatencySettings.swift" "$ROOT/mac/DebugSettings.swift" "$ROOT/mac/DebugStats.swift" "$ROOT/tests/DebugStatsTest.swift" -o "$ROOT/build/tests/debug-stats-test"
"$ROOT/build/tests/debug-stats-test"
